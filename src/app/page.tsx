...
const Home = () => {
  useEffect(() => {
    if (typeof window !== 'undefined') {
      console.log('Client-specific logic here');
    }
  }, []);

  return (
    <div>
      <section className=" lg:h-[400px] h-auto">
        <div className=" w-full flex flex-col items-center text-center px-11 gap-11 py-24 md:flex-row md:text-left">
          ...
          <div className="md:w-1/2">
            ...
            <div className="mt-6 space-x-4">
              <Link href="/blog">
                <button className="bg-purple-500 hover:bg-purple-600 font-medium px-6 py-2 rounded shadow-md">
                  Explore Blogs
                </button>
              </Link>
              <Link href="/about">
                <button className="hover:bg-gray-200 font-medium px-6 py-2 rounded shadow-md">
                  About Me
                </button>
              </Link>
            </div>
